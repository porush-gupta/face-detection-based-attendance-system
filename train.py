...
#if something goes wrong error pop #

def contact():
    mess._show(title='Contact us', message="Please contact us on : 'porushgupta20@gmail.com' ")
##
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file missing', message='Please check the file ')
        window.destroy()
...
message = tk.Label(frame2, text="" ,bg="#00aeff" ,fg="yellow"  ,width=39,height=1, activebackground = "green" ,font=('times', 16, ' bold '))
